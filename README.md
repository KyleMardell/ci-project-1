...
The deployed site can be found here - [Garden Collective](https://kylemardell.github.io/garden-collective/)
...
The site is made up of 6 pages, 4 main site pages, a form submittion confirmation page and a 404 page.
...
- Font used on the website are from [Google Fonts](https://fonts.google.com/)
